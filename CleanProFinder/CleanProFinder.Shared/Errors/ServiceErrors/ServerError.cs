...
namespace CleanProFinder.Shared.Errors.ServiceErrors
{
    public class ServerError : ServiceError
    {
        ...
        public static CleaningServiceError GetOwnCleaningServicesError => new CleaningServiceError("Server error", "Get Own Cleaning Services Error", 7);
        public static CleaningServiceError GetOwnCleaningServiceError => new CleaningServiceError("Server error", "Get Own Cleaning Service Error", 8);
