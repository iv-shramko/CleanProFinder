...
namespace CleanProFinder.Db.Migrations
{
    ...
    [Migration("20231202135316_IsRestrictedUserProperties")]
    partial class IsRestrictedUserProperties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanProFinder.Db.Models.RequestInteraction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RequestInteractions");
                });

            modelBuilder.Entity("CleanProFinder.Db.Models.SavedProvider", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CleanProFinder.Db.Models.RequestInteraction", b =>
                {
                    ...
                    b.HasOne("CleanProFinder.Db.Models.Request", "Request")
                        .WithMany("Interactions")
            ...
            modelBuilder.Entity("CleanProFinder.Db.Models.SavedProvider", b =>
                {
                    ...
                    b.HasOne("CleanProFinder.Db.Models.ServiceUser", "ServiceUser")
                        .WithMany("SavedProviders")
